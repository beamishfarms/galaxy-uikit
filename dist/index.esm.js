...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "images/galaxy/logo.svg" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "205", height: "26", href: isDark ? 'images/galaxy/logowithtext.svg' : 'images/galaxy/logowithtext.svg' })));
};
...
var MenuLink = function (_a) {
    ...
    return React.createElement(Tag, __assign({ style: { color: '#ffffff' } }, props, otherProps));
};
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "md", onClick: function () {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#0F0B25", backgroundDisabled: "#0F0B25", contrast: "#191326", invertedContrast: "#99A3FF", input: "#191439", tertiary: "#99A3FF", text: "#FFFFFF", textDisabled: "#5B5B5B", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#110D2A", gradients: {
        bubblegum: "linear-gradient(139.73deg, #99A3FF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "rgba(86,65,216,0.4)", background: "#0F0B25", backgroundDisabled: "#0F0B25", contrast: "#FFFFFF", invertedContrast: "#99A3FF", input: "#191439", primaryDark: "#99A3FF", tertiary: "#99A3FF", text: "#FFFFFF", textDisabled: "#5B5B5B", textSubtle: "#8f80ba", borderColor: "#524B63", card: "#110D2A", gradients: {
