...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#0F0B25", backgroundDisabled: "#3c3742", contrast: "#191326", invertedContrast: "#99A3FF", input: "#99A3FF", tertiary: "#99A3FF", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#99A3FF", borderColor: "#E9EAEB", card: "#110D2A", gradients: {
        bubblegum: "linear-gradient(139.73deg, #99A3FF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "rgba(86,65,216,0.4)", background: "#0F0B25", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#99A3FF", input: "#99A3FF", primaryDark: "#99A3FF", tertiary: "#99A3FF", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#99A3FF", borderColor: "#524B63", card: "#110D2A", gradients: {
